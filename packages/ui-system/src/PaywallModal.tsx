          ...
          <div className="p-8 w-full">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 mb-8 text-center relative overflow-hidden">
              ...
              <p className="text-slate-400 text-sm font-medium decoration-slate-400/50 mb-1">
                Precio Habitual:{' '}
                <span className="line-through decoration-red-400 decoration-2">500€</span>
              </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs text-slate-500">
                    Gestiona toda tu cartera sin restricciones.
                  </span>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-sm font-bold text-slate-800 block">
                    Informes Clínicos Profesionales (PDF)
                  </span>
                  <span className="text-xs text-slate-500">
                    Genera devoluciones automáticas en un clic.
                  </span>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs text-slate-500">
                    Acceso VIP a futuras mejoras del software.
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <Button
                ...
                onClick={() => {
                  // Using the configurable checkout link
              ...
              <div className="flex flex-col items-center justify-center gap-2 text-center">
                <p className="text-xs text-slate-500 font-medium">
                  <span className="font-bold text-slate-700">IMPORTANTE:</span> El correo que uses
                  en el pago se convertirá automáticamente en tu{' '}
                  <span className="font-bold text-pink-600">Llave de Acceso Universal</span>.
                </p>
                <div className="flex items-center gap-4 text-[10px] text-slate-400 font-medium mt-2">
                  <span className="flex items-center gap-1">
                    <Check size={10} /> Pago 100% Seguro
                  </span>
                  <span>•</span>
