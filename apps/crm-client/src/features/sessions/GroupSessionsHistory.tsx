  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-black text-slate-800 tracking-tight">Bitácora Grupal</h1>
      ...
      {/* Stats Summary */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">{/* Placeholder Stats */}</div>
                    ...
                    <tr key={session.id} className="hover:bg-slate-50 transition-colors group">
                      ...
                      <td className="p-4">
                        <div className="font-bold text-slate-800">
                          {session.groupName || 'Grupo Sin Nombre'}
                        </div>
