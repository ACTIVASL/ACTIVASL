...
import { Music, HeartPulse, ShieldAlert, Disc, X, CheckCircle2, Mic2 } from 'lucide-react';
            ...
            <div className="space-y-4">
              <div>
                ...
                <TagInput
                  ...
                  onRemove={(t: string) =>
                    setIso((p) => ({ ...p, likes: p.likes.filter((x) => x !== t) }))
                  }
                  color="slate"
                />
              </div>
              <div>
                ...
                <TagInput
                  ...
                  onAdd={(t: string) =>
                    setIso((p) => ({
                      ...p,
                      instrumentsOfInterest: [...(p.instrumentsOfInterest || []), t],
                    }))
                  }
                  onRemove={(t: string) =>
                    setIso((p) => ({
                      ...p,
                      instrumentsOfInterest: (p.instrumentsOfInterest || []).filter((x) => x !== t),
                    }))
                  }
                  color="emerald"
                />
