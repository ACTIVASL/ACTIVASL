...
export const Software = ({ onOpenModal }: SoftwareProps) => {
  return (
    <section
      id="software"
      className="relative overflow-hidden py-32 px-6 lg:px-12 bg-white border-y border-gray-100"
    >
        ...
        <RevealSection>
          <div className="flex flex-col gap-10 relative z-10">
            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-[#0A0F1D] border border-gray-800 w-fit shadow-xl">
              ...
              <span className="text-xs font-['Outfit'] font-bold text-white tracking-[0.2em] uppercase">
                Soberanía Digital
              </span>
            </div>
            ...
            <p className="text-[#64748B] font-['Inter'] text-xl leading-relaxed font-light max-w-lg">
              CRM propio, ERP de facturación y PWA corporativa. Sin dependencias de terceros.
              Tus datos son tuyos.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 border-y border-gray-100 py-8">
              <div className="text-center">
                <p className="text-3xl font-['Outfit'] font-bold text-[#0A0F1D]">
                  <Counter value={100} />%
                </p>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <button
                ...
                className="flex cursor-pointer items-center justify-center rounded-2xl h-16 px-10 bg-[#EC008C] hover:bg-[#D6007E] transition-all text-white text-base font-['Outfit'] font-bold shadow-2xl shadow-[#EC008C]/30 transform active:scale-95 duration-300 uppercase tracking-wide"
              >
                Contratar SaaS (299€)
              </button>
              <button
                onClick={() => onOpenModal?.('contact')}
                className="flex cursor-pointer items-center justify-center rounded-2xl h-16 px-10 bg-white border border-gray-200 hover:border-[#0A0F1D] text-[#0A0F1D] text-base font-['Outfit'] font-bold transition-all group active:scale-95 duration-300 hover:shadow-xl uppercase tracking-wide"
              >
                <Sparkles
                  className="mr-3 text-slate-400 group-hover:text-[#EC008C] transition-colors"
                  size={24}
                />
                White Label (3000€)
              </button>
        ...
        <div className="relative z-10 w-full lg:h-[800px] flex items-center justify-center perspective-container py-20 lg:py-0">
          ...
          <div className="relative w-[90%] lg:w-[800px] aspect-[16/10] bg-[#0A0F1D] rounded-xl shadow-2xl shadow-[#0A0F1D]/30 border-[6px] border-[#0A0F1D] ring-1 ring-gray-800 z-10 transition-transform duration-700 hover:scale-[1.01] overflow-hidden group/desktop">
            ...
            <div className="w-full h-full bg-slate-900 overflow-hidden relative">
              <img
                src={crmDesktop}
                alt="Panel de Control Empresarial ERP"
                className="w-full h-full object-cover object-top bg-slate-900 opacity-90 group-hover/desktop:opacity-100 transition-opacity"
                loading="lazy"
              />
              {/* Reflection */}
          ...
          <div
            className="absolute -bottom-10 right-0 lg:-right-12 lg:bottom-20 w-[60%] lg:w-[450px] aspect-[4/3] bg-[#1a1a1a] rounded-[1.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] border-[8px] border-[#1a1a1a] ring-1 ring-gray-700 z-20 animate-float"
            style={{ animationDelay: '1s' }}
          >
            <div className="w-full h-full bg-slate-800 rounded-2xl overflow-hidden relative group/tablet">
              <img
                src={crmTablet}
                alt="Gestión de Recursos en Tablet"
          ...
          <div
            className="absolute -bottom-20 left-4 lg:left-0 lg:bottom-40 w-[35%] lg:w-[240px] aspect-[9/19.5] bg-black rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(236,0,140,0.4)] border-[8px] border-black ring-1 ring-gray-800 z-30 animate-float"
            style={{ animationDelay: '0s' }}
          >
            <div className="w-full h-full bg-slate-900 rounded-[2rem] overflow-hidden relative group/mobile">
              <img
                src={crmMobile}
                alt="App Móvil Corporativa"
