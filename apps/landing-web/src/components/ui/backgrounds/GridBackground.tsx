...
export const GridBackground = () => {
    ...
    useEffect(() => {
        ...
        class Particle {
            ...
            constructor() {
                this.x = Math.round(Math.random() * width / GRID) * GRID;
                this.y = Math.round(Math.random() * height / GRID) * GRID;
            ...
            update() {
                ...
                if (Math.abs(dx) < 1 && Math.abs(dy) < 1) {
                    ...
                    if (this.tx > width) this.tx = width;
                    if (this.ty < 0) this.ty = 0;
                    if (this.ty > height) this.ty = height;
                } else {
                    this.x += dx * 0.1;
                    this.y += dy * 0.1;
                }
