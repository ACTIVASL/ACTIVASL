        ...
        <div className="p-6">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="label-pro mb-1.5 block text-slate-400">
                  Horario Habitual (Opcional)
                </label>
                <div className="relative">
                  <Calendar className="absolute left-3 top-3 text-slate-300" size={16} />
                  <input className="input-pro pl-9 text-lg p-3" placeholder="Ej. Lunes 10:00" />
                </div>
              </div>
              <div>
                <label className="label-pro mb-1.5 block text-slate-400">
                ...
                <input className="input-pro text-lg p-3" placeholder="Ej. Sala 2" />
              </div>
            </div>
