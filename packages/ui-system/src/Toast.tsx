...
export const Toast = ({ message, type = 'success', onClose }: ToastProps) => (
  <div className="fixed top-4 left-4 right-4 md:left-auto md:top-auto md:bottom-6 md:right-6 z-[9999] animate-in slide-in-from-top-4 md:slide-in-from-bottom-4 fade-in duration-300 flex justify-center md:block">
    <div
