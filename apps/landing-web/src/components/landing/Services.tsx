...
const Services = () => {
    return (
        <section className="relative py-32 bg-gradient-to-b from-slate-900 to-blue-950 overflow-hidden" id="solutions">
                        ...
                        <div className="order-1 lg:order-2 space-y-8">
                            ...
                            <div className="flex gap-4">
                                <button
                                    ...
                                    className="px-8 py-4 bg-slate-900 border border-brand-primary/50 text-white rounded-full font-bold shadow-[0_0_20px_-5px_rgba(96,165,250,0.5)] hover:shadow-[0_0_30px_-5px_rgba(96,165,250,0.8)] hover:border-brand-primary hover:bg-slate-800 transition-all"
                                >
                                    VER CATÁLOGO
                                </button>
                                <button
                                    onClick={() => window.location.href = 'mailto:auditoria@activa-sl.digital'}
                                    className="px-8 py-4 bg-slate-900/50 border border-white/20 text-white rounded-full font-bold hover:bg-slate-900 hover:border-brand-primary/50 hover:shadow-[0_0_20px_-5px_rgba(96,165,250,0.3)] transition-all"
                                >
                                    AUDITORÍA TÉCNICA
                                </button>
                            </div>
                    ...
                    >
                        ...
                        <div className="space-y-8 order-1">
                            ...
                            <div className="relative group/card cursor-pointer">
                                <SpotlightCard className="rounded-2xl bg-slate-900 shadow-[0_0_30px_-10px_rgba(96,165,250,0.3)] hover:shadow-[0_0_40px_-5px_rgba(96,165,250,0.5)] transition-all p-6">
