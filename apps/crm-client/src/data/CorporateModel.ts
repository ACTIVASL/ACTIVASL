...
import {
    Landmark, Settings, Server, Lightbulb, Headset, Globe, Briefcase, Scale, TrendingUp,
    Magnet, Shield, PhoneForwarded, Rocket,
    LucideIcon
} from 'lucide-react';

export type SquadRole = 'SALES' | 'OPS' | 'ADMIN' | 'LEGAL' | 'TECH' | 'OTHER';

export interface Automation {
    id: string;
    name: string;           // ej: "Generador Posts LinkedIn"
    type: 'content' | 'report' | 'email' | 'social';
    status: 'active' | 'paused' | 'error';
    lastRun?: string;       // fecha última ejecución
    output?: string;        // descripción del output
}
...
export interface SquadMember {
    ...
    workspaceEmail?: string;     // ej: marketing@activasl.com
    geminiUrl?: string;          // Enlace a Gemini Pro (PRIVADO del empleado)
    automations?: Automation[];  // Automatizaciones activas
}
...
export interface SectionData {
    status: 'empty' | 'ready' | 'active' | 'warning';
    id: string;
    title: string;
    ceoObjective: string;
    squad: SquadMember[];
...
export interface CorporateModel {
    key_partners: SectionData;
    key_activities: SectionData;
    key_resources: SectionData;
    value_propositions: SectionData;
    customer_relationships: SectionData;
    channels: SectionData;
    customer_segments: SectionData;
    cost_structure: SectionData;
    revenue_streams: SectionData;
}

export interface SectionConfig {
    id: keyof CorporateModel;
    canvasTitle: string;
    title: string;
    ceoObjective: string;
    icon: LucideIcon;
    ...
    glow: string; // Tailwind class
    description: string; // Descripción breve
    prompt: string; // Prompt base para el agente
    hoverBorder?: string; // Optional hover style
}

// --- DATOS INICIALES (ESTRUCTURA CORPORATIVA ESPAÑOLA - 100 EMPLEADOS) ---
export const INITIAL_MODEL_DATA: CorporateModel = {
    key_partners: { // 6 PERSONAS
        status: 'ready',
        id: 'key_partners', title: 'Socios Clave',
    ...
    key_activities: { // 12 PERSONAS
        status: 'active',
        id: 'key_activities', title: 'Actividades Clave',
    ...
    key_resources: { // 14 PERSONAS
        status: 'ready',
        id: 'key_resources', title: 'Recursos Clave',
        ...
        squad: [
            {
                ...
                salary: 120000,
                active: true,
                function: "Visión y Estrategia Global.",
                agent: "ACTIVA-Principal",
                result: "Crecimiento > 25%",
                notebookUrl: "https://notebooklm.google.com/notebook/476040c7-e5e6-4922-ba98-66af83b35bd8?authuser=1"
            },
    ...
    value_propositions: { // 5 PERSONAS (EQUIPO PRODUCTO)
        status: 'ready',
        id: 'value_propositions', title: 'Propuesta de Valor',
        ceoObjective: "Vender tranquilidad: Dormir tranquilo y tener el control total del negocio.",
        // --- NUEVO: CATÁLOGO DE SERVICIOS RENOMBRADO PARA PYMES (BENEFICIO PURO) ---
        products: [
    ...
    customer_relationships: { // 13 PERSONAS
        status: 'active',
        id: 'customer_relationships', title: 'Relaciones con Clientes',
    ...
    channels: { // 13 PERSONAS (MÚSCULO MARKETING)
        status: 'ready',
    ...
    customer_segments: { // 5 PERSONAS - ADIÓS TRIBUS, HOLA SECTORES
        status: 'ready',
    ...
    cost_structure: { // 8 PERSONAS
        status: 'active',
        id: 'cost_structure', title: 'Estructura de Costes',
    ...
    revenue_streams: { // 24 PERSONAS (LA FUERZA DE VENTAS)
        status: 'active',
        id: 'revenue_streams', title: 'Fuentes de Ingresos',
...
export const SECTIONS: Record<keyof CorporateModel, SectionConfig> = {
    key_partners: {
        id: 'key_partners',
        canvasTitle: 'Socios Clave',
        title: 'Dpto. Legal y Alianzas',
        ...
        prompt: "Actúa como ACTIVA-Legal. Analiza el borrador del contrato adjunto para identificar cláusulas de responsabilidad civil que superen el estándar del mercado y sugiere una redacción alternativa."
    },
    key_activities: {
        id: 'key_activities',
        canvasTitle: 'Actividades Clave',
        title: 'Dpto. de Operaciones',
        ...
        prompt: "Actúa como ACTIVA-Ops. Genera un cronograma detallado de implementación para un cliente del sector sanitario con 5 sedes."
    },
    key_resources: {
        id: 'key_resources',
        canvasTitle: 'Recursos Clave',
        title: 'Dpto. Tecnología y Personas',
        ceoObjective: "Infraestructura escalable y retención de talento clave (eNPS > 50).",
        icon: Server,
        theme: 'violet',
        ...
        prompt: "Actúa como ACTIVA-Tech. Diseña una arquitectura de microservicios escalable para soportar un pico de 10,000 usuarios concurrentes."
    },
    value_propositions: {
        id: 'value_propositions',
        canvasTitle: 'Propuesta de Valor',
        ...
        prompt: "Actúa como ACTIVA-Vision. Analiza las tendencias emergentes en IA generativa para el sector legal."
    },
    customer_relationships: {
        id: 'customer_relationships',
        canvasTitle: 'Relaciones con Clientes',
        title: 'Dpto. Atención al Cliente',
        ceoObjective: "Maximizar el valor de vida del cliente y mantener la tasa de baja < 1.2% mensual.",
        icon: Headset,
        theme: 'rose',
        ...
        prompt: "Actúa como ACTIVA-Exito. Redacta un plan de recuperación para un cliente clave en riesgo de baja."
    },
    channels: {
        id: 'channels',
        canvasTitle: 'Canales',
        title: 'Dpto. de Marketing',
        ceoObjective: "Optimización del coste de adquisición < 30€ y escalado de canales.",
        icon: Globe,
        theme: 'orange',
        ...
        prompt: "Actúa como ACTIVA-Marketing. Desarrolla una estrategia de lanzamiento para el nuevo módulo de IA en LinkedIn."
    },
    customer_segments: {
        id: 'customer_segments',
        canvasTitle: 'Segmentos de Clientes',
        title: 'PYME Española B2B',
        ceoObjective: "Ser la columna vertebral tecnológica de los sectores HORECA, Salud y Legal.",
        icon: Briefcase,
        theme: 'teal',
        ...
        description: 'Profesionales hartos del alquiler de software. Buscan control total y valoran su tiempo por encima de todo.',
        prompt: "Actúa como ACTIVA-Analisis. Realiza un análisis PESTEL abreviado para el sector de la restauración en España."
    },
    cost_structure: {
        id: 'cost_structure',
        canvasTitle: 'Estructura de Costes',
        title: 'Dpto. Financiero',
        ceoObjective: "Sostenibilidad financiera con EBITDA > 25% y optimización fiscal.",
        icon: Scale,
        theme: 'emerald',
        ...
        prompt: "Actúa como ACTIVA-Finanzas. Elabora un informe ejecutivo sobre la desviación presupuestaria del tercer trimestre."
    },
    revenue_streams: {
        id: 'revenue_streams',
        canvasTitle: 'Fuentes de Ingresos',
        ...
        prompt: "Actúa como ACTIVA-Cierre. Prepara una propuesta comercial de alto valor para un cliente corporativo."
    },
};
