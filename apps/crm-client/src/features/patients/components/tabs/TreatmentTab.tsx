          ...
          <div className="relative z-10">
            ...
            {patient.safetyProfile ? (
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-100">
                  <div>
                    ...
                    <p className="font-bold text-slate-700 capitalize text-sm">
                      {MOBILITY_MAP[patient.safetyProfile.mobilityAid || 'none'] ||
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 truncate">
                      {patient.safetyProfile.allergies || 'Ninguna'}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center py-6 bg-slate-50 rounded-lg border border-dashed border-slate-200">
                <Button size="sm" onClick={() => setShowSafetyModal(true)}>
            ...
            {patient.musicalIdentity ? (
              <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {patient.musicalIdentity.dislikes.length > 0 ? (
                      patient.musicalIdentity.dislikes.map((s, i) => (
                        <span
                          key={i}
                          className="text-xs bg-red-50 text-red-700 px-2 py-0.5 rounded border border-red-100"
                        >
                          {s}
                        </span>
                      ))
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 truncate">
                    {patient.musicalIdentity.instrumentsOfInterest?.join(', ') ||
                      'Ninguno registrado'}
                  </p>
                </div>
              </div>
              ...
              <div className="text-center py-6 bg-slate-50 rounded-lg border border-dashed border-slate-200">
                <Button size="sm" onClick={() => setShowIsoModal(true)}>
