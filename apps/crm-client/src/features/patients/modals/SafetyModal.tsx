...
import { ShieldAlert, AlertTriangle, HeartPulse, CheckCircle2, X, ShieldCheck } from 'lucide-react';
              ...
              {[
                ...
                <button
                  ...
                  onClick={() =>
                    setSafety({
                      ...safety,
                      mobilityAid: opt.val as ClinicalSafetyProfile['mobilityAid'],
                    })
                  }
                  className={`text-sm py-2 px-3 rounded-lg border font-medium transition-all ${
                    safety.mobilityAid === opt.val
...
const RiskToggle = ({
  ...
  <div
    onClick={onClick}
    className={`p-3 rounded-xl border cursor-pointer transition-all active:scale-95 ${
      active
