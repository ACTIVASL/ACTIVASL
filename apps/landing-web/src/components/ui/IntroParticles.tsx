...
export const IntroParticles = ({ onComplete }: { onComplete: () => void }) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[100] flex items-center justify-center transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0 scale-110 pointer-events-none'}`}
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[#3B82F6] font-mono text-xs tracking-[0.3em] uppercase">
            Sincronizando
          </span>
