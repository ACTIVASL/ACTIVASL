...
const RESOURCES = [
  {
    id: 'moca',
    title: 'MoCA - Evaluación Cognitiva Montreal',
    description: 'Screening de deterioro cognitivo leve y demencia.',
    color: 'indigo',
  },
  {
    id: 'mmse',
    title: 'MMSE - Mini-Mental State Examination',
    description: 'Evaluación rápida del estado cognitivo.',
    color: 'blue',
  },
  {
    id: 'gds',
    title: 'GDS - Escala Yesavage (15 Ítems)',
    description: 'Screening de depresión geriátrica.',
    color: 'emerald',
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {RESOURCES.map((res) => (
          ...
          >
            <div>
              <div
                className={`w-12 h-12 rounded-xl bg-${res.color}-50 text-${res.color}-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
              >
